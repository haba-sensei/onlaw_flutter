...
class MainContenido extends StatelessWidget {
  const MainContenido({Key? key, required this.lista, required this.ruta}) : super(key: key);
  final List<MenuContentModel> lista;
  final String ruta;
  @override
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          // }
                          Get.toNamed(ruta, arguments: lista[index]);
                        ...
                        child: ElevatedButton(
                            onPressed: () {
                              Get.defaultDialog(
                                ...
                                content: DialogOpciones(item: lista[index]),
