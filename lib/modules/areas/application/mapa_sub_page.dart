...
import 'package:onlaw/modules/areas/infrastructure/mapa_sub_controller.dart'; 
import 'package:onlaw/modules/areas/widgets/main_contenido.dart';
import 'package:onlaw/routes/routes_names.dart';

class MapaSubPage extends StatelessWidget {
  const MapaSubPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<MapaSubController>(
        init: MapaSubController(),
        builder: (_) {
          return Scaffold(
            extendBody: true,
            ...
            body: SafeArea(
              ...
              MainContenido(ruta: Routes.mapaSub, lista: _.mapaSub)
            ])),
          );
        });
  }
