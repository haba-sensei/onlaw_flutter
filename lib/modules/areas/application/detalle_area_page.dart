...
import 'package:onlaw/modules/areas/infrastructure/det_cont_area_controller.dart';
import 'package:onlaw/modules/areas/widgets/main_contenido.dart';
import 'package:onlaw/routes/routes_names.dart';

class DetContAreaPage extends StatelessWidget {
  const DetContAreaPage({Key? key}) : super(key: key);
